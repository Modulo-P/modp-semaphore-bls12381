/* 
  Code from Semphore protocol repository  https://github.com/semaphore-protocol/semaphore/blob/main/packages/.
  Please refer to the original repository for more information. 
  https://github.com/semaphore-protocol/semaphore/blob/main/LICENSE
 */
